# internal-barrel-imports Specification

## Purpose

Standardize barrel libraries and `package:dart_test_gen/...` imports under `lib/` and `lib/src/` so internal references stay stable and navigable.
