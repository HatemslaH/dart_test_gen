...
- **THEN** methods SHALL use arithmetic patterns that are realistic regression targets (e.g. repeated fractional accumulation, linear interpolation), not only trivial constants
