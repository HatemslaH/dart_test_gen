# lib-src-file-granularity Specification

## Purpose

Constrain how `lib/src/` libraries are scoped so facades stay thin and each file has an obvious primary responsibility.
