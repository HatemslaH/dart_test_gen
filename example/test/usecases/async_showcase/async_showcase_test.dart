...
void main() {
  ...
  group('computeScore', () {
    ...
    test('computeScore(10, Priority.low)', () async {
      final base = 10;
      final priority = Priority.low;
      final expected = 10;
      final actual = await asyncshowcase.computeScore(base, priority);
    ...
    test('computeScore(10, Priority.normal)', () async {
      final base = 10;
      final priority = Priority.normal;
      final expected = 11;
      final actual = await asyncshowcase.computeScore(base, priority);
    ...
    test('computeScore(10, Priority.high)', () async {
      final base = 10;
      final priority = Priority.high;
      final expected = 12;
      final actual = await asyncshowcase.computeScore(base, priority);
    ...
    test('computeScore(10, Priority.critical)', () async {
      final base = 10;
      final priority = Priority.critical;
      final expected = 13;
      final actual = await asyncshowcase.computeScore(base, priority);
